...
**(c)** The $$\pi^0$$ decays into a symmetric electron-positron pair.  In terms of the speed of light, what is
the velocity of the electron and of the positron *as observed from the rest frame of the* $$\pi^0$$?
...
3. .$$^{40}_{19}{\text{K}}\:\to\:^{36}_{36}\text{Cl}+e^-+\bar{\nu}_e$$
4. .$$^{40}_{19}{\text{K}}\:\to\:^{40}_{40}\text{Ca}+e^++\nu_e$$
5. .$$^{40}_{19}{\text{K}}\:\to\:^{39}_{39}\text{Ar}+e^++\nu_e$$
...
1. .$$M_{\text{}}>N\:m_{\text{neutron}}+Z\:m_{\text{proton}}$$
2. .$$M_{\text{}}=N\:m_{\text{neutron}}+Z\:m_{\text{proton}}$$
3. .$$M_{\text{}}<N\:m_{\text{neutron}}+Z\:m_{\text{proton}}$$
4. .$$M_{\text{}}=N\:m_{\text{neutron}}+Z\:m_{\text{proton}}$$, but only if $$N>Z$$
5. .$$M_{\text{}}<N\:m_{\text{neutron}}+Z\:m_{\text{proton}}$$, but only if $$N>Z$$
